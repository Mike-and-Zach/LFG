                    ...
                    <ul className="navbar">
                            <li className="navbar-links">
                                <div className="home-container">
                                    ...
                                    <Link to="/posts" className="single-links" id="home">Home</Link>
                                </div>
                            </li>   
                            {username&&<li className="navbar-links">
                                <div className="inbox-container">
                                    <MailIcon fontSize="small" sx={{ fontSize: 18 }}/>
                                    <Link to="/inbox" className="single-links">Inbox</Link>
                                </div>
                                </li>}
                            ...
                            {!username && <li className="navbar-links">
                                <div className="login-container">
                                    ...
                                    <Link to="/login" className="single-links">Login</Link>
                                </div>
                                </li>}
                            {!username && <li className="navbar-links">
                            ...
                            {username && <li className="navbar-links">
                                ...
                                <Link to="/login" className="logout-btn" onClick={() => {
